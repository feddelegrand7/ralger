...
- **nodes**: which is a vector of CSS elements that you want to extract. These elements whill form the columns of your dataframe;
...
```
Note that all columns we'll have the *character* class. You'll need to convert them according to your needs. Finally, I appreciate any feedback, please reach out or DM at [ihaddadenfodil](https://twitter.com/IhaddadenFodil). 
